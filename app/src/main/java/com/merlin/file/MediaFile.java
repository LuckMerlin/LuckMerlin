 ...
 *@version 0.0.0
 *Create Time:Jul 24, 2017 10:30:00 AM 
 *
 */
public class MediaFile {
	 // PathMatcher file types
    ...
    public static final int FILE_TYPE_VOB     = 203;
    public static final int FILE_TYPE_FLV     = 204;
...
//        }
        ...
        addFileType("RM", FILE_TYPE_RM, "video/rm");
